...
export const Dialog = ({ children, onOpen, onClose, id=1, od=35, orp=57 }) => {
  return (
    <dialog id='dialog' open={true} className='border-0 text-white' style={dialog}>
      <button
      ...
      <div className='bg-dark rounded-4' style={content}>
        <div className="p-1">
            ...
            // onClick={onClose}
            >
                <img className="invert col-5" src='https://img.icons8.com/?size=256&id=pVOup2X72g9B&format=png' />
            </button>
        </div>
